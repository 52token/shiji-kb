...
### [source-inference/](source-inference/) ✨ **重大更新**
史料溯源推理研究，分析太史公如何获知历史事件。

**最新成果 (2026-03-26)**:
- 整合李开元四部曲30+种方法到SKILL_07d
- 新增《安史之乱》8种方法（宣传解构、财政计算、战场重建等）
- 新增案例11（长平之战）：首次财政计算揭示赵王换将真因
- 新增案例12（冯谖烧券买义）：首次经济学分析战国债务免除
- 建立知识图谱对齐规范，所有案例关联事件索引和常识库
- **案例总数**: 12个（前10个李开元方法，后2个安史之乱方法）
- **总字数**: 约150,000字
