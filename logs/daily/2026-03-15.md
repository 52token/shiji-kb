...
官职和身份类实体分类混乱（2290+4297处待重分类），地名误分类60处，标注残留影响25章质量，人物和生物本体需发布v2.9。本日集中处理实体重分类和本体发布。

**要解决什么问题？**

官职身份分类不准确，地名误标，标注残留，嵌套标签和跨句标注错误，kg/子目录缺README导航。

**会影响什么最终交付物？**

官职2290处+身份4297处+地名60处重分类提升准确率，25章标注残留清理，v2.9人物和生物本体发布，9个kg/子目录README完善导航。
